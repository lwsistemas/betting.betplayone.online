...
<li>
    ...
    <li>
        <a  href="<?php echo e(route('home')); ?>"> <i class="far fa-globe-americas"></i> <span><?php echo e(trans('All Sports')); ?></span>
        </a>
    </li>
                ...
                <ul class="">
                    <?php $__empty_2 = true; $__currentLoopData = $gameCategory->activeTournament; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                        <li>
                            ...
                            <img src="<?php echo e($tItem->image_path); ?>" style="height:22px;"> <?php echo e($tItem->name); ?></a>
                        </li>
...
<?php /**PATH C:\xampp2\htdocs\betting.betplayone.online\resources\views/themes/betting/partials/home/leftMenu.blade.php ENDPATH**/ ?>