            ...
            methods: {
                ...
                addToSlip(data) {
                    ...
                    if (index === -1) {
                        ...
                        Notiflix.Notify.Success("Aposta adcionada");
                    } else {
                        ...
                        Notiflix.Notify.Info("Sua aposta mudou");
                    }
...
<?php echo $__env->make($theme.'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\betting.betplayone.online\resources\views/themes/betting/home.blade.php ENDPATH**/ ?>