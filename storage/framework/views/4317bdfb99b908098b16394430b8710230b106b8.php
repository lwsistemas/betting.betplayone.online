...
<nav class="navbar navbar-expand-md fixed-top">
    <div class="container-fluid">
        ...
        <div class="saldomenu">
            <div><sup><?php echo e(config('basic.currency_symbol')); ?></sup> <?php echo e(Auth()->user()->balance); ?></div>
            <div class="depositar">
                <a href="<?php echo e(route('user.addFund')); ?>">Depositar agora</a>
            </div>
        </div>
        <?php endif; ?>
        <div class="navbar-text">
            ...
            <div class="dropdown user-dropdown d-inline-block">
                ...
                <ul class="dropdown-menu">
                    <li style="color:#FFFFFF; font-size: 22px;float: right;padding: 5px; padding-right: 25px;"><sup><?php echo e(config('basic.currency_symbol')); ?></sup> <?php echo e(Auth()->user()->balance); ?></li>
                    <li>
                    ...
                    <li>
                        <a class="dropdown-item <?php echo e(menuActive('user.payout.money')); ?>" href="<?php echo e(route('user.payout.money')); ?>">
                    ...
                    <li>
                        <a class="dropdown-item <?php echo e(menuActive('user.betHistory')); ?>" href="<?php echo e(route('user.betHistory')); ?>">
            ...
            <div class="notification-panel" id="pushNotificationArea">
                ...
                <ul class="notification-dropdown">
                    ...
                    <div class="clear-all fixed-bottom">
                        <a v-if="items.length > 0" @click.prevent="readAll" href="javascript:void(0)"><?php echo app('translator')->get('Clear all'); ?></a>
                ...
                <a href="<?php echo e(route('register')); ?>" class="btn-custom"><?php echo app('translator')->get('Join'); ?></a>
                <a href="<?php echo e(route('login')); ?>" class="btn-custom"><?php echo app('translator')->get('Login'); ?></a>
...
<?php endif; ?>
<?php /**PATH C:\xampp2\htdocs\betting.betplayone.online\resources\views/themes/betting/partials/nav.blade.php ENDPATH**/ ?>