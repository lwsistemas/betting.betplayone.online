            ...
            if (0 < obj.length) {
                obj.map(function(obj, i) {
                    ...
                    `<tr>
                        ...
                        <td data-label="<?php echo app('translator')->get('Match Name'); ?>"><a href=''>${obj.match_name}</a></td>
...
<?php echo $__env->make($theme.'layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\betting.betplayone.online\resources\views/themes/betting/user/betHistory/index.blade.php ENDPATH**/ ?>