                        ...
                        <div id="home"
                            ...
                            <form action="<?php echo e(route('user.updateInformation')); ?>" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <label><?php echo app('translator')->get('CPF'); ?></label>
                                        <div class="form-group input-box mb-3">
                                            <input class="form-control" type="text" name="CPF"
                                                   value="<?php echo e(old('CPF')?: $user->CPF); ?>">
                                            <?php if($errors->has('CPF')): ?>
                                                <div
                                                    class="error text-danger"><?php echo app('translator')->get($errors->first('CPF')); ?> </div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
...
<?php echo $__env->make($theme.'layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\betting.betplayone.online\resources\views/themes/betting/user/profile/myprofile.blade.php ENDPATH**/ ?>