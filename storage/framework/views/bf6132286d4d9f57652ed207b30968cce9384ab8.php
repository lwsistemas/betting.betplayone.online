    ...
    <div class="leftbar" id="userPanelSideBar">
        ...
        <div class="top profile">
            <h4 class="d-flex justify-content-between p-3">
                <?php echo app('translator')->get('hello'); ?> <?php echo e(auth()->user()->firstname); ?>
...
<?php /**PATH C:\xampp2\htdocs\betting.betplayone.online\resources\views/themes/betting/layouts/user.blade.php ENDPATH**/ ?>