    ...
    <table class="table table-striped">
        <thead>
            <tr>
                <th class="text-center">
                    <img :src="item.game_tournament.image_path">
                </th>
                <th class="col-5">
                    <span>
                        {{item.game_tournament.name}}
                    </span>
                </th>
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <a @click="goMatch(item)">
                        <h4>
                            <span>
                                <img :src="item.team1_img" alt=".." style="height: 36px; width:auto;">
                                {{ item.team1 }}
                            </span>
                            <span style="font-size:32px;">VS</span>
                            <span>
                                {{ item.team2 }}
                                <img :src="item.team2_img" alt=".." style="height: 36px; width:auto;">
                            </span>
                        </h4>
                        <p>
            ...
            <tr>
                ...
                <td>
                    <h4>
                        ...
                        <span class="float-end">
                            <a href="" class="me-2">
                                <i class="fal fa-chart-bar"></i> {{item.start_date}}
                            </a>
                        </span>
                    </p>
                </td>
        ...
        <div class="box" v-for="(item, index) in allSports_filter">
            ...
            <div class="row d-flex justify-content-around align-items-center">
                ...
                <div class="col-6">
                    ...
                    <button class="btn-custom w-75 my-2" @click="goMatch(item)"><?php echo app('translator')->get('Apostar'); ?></button>
                </div>
                <div class="col-3 team">
...
<?php /**PATH C:\xampp2\htdocs\betting.betplayone.online\resources\views/themes/betting/partials/home/content.blade.php ENDPATH**/ ?>