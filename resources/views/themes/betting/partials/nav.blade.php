...
<nav class="navbar navbar-expand-md fixed-top">
    <div class="container-fluid">
        ...
        @auth
        <div class="saldomenu">
            <div><sup>{{config('basic.currency_symbol')}}</sup> {{Auth()->user()->balance}}</div>
            <div class="depositar">
                <a href="{{route('user.addFund')}}">Depositar agora</a>
            </div>
        </div>
        @endauth
        <div class="navbar-text">
            ...
            <div class="dropdown user-dropdown d-inline-block">
                ...
                <ul class="dropdown-menu">
                    <li style="color:#FFFFFF; font-size: 22px;float: right;padding: 5px; padding-right: 25px;"><sup>{{config('basic.currency_symbol')}}</sup> {{Auth()->user()->balance}}</li>
                    <li>
            ...
            <div class="notification-panel" id="pushNotificationArea">
                ...
                <ul class="notification-dropdown">
                    ...
                    <div class="clear-all fixed-bottom">
                        <a v-if="items.length > 0" @click.prevent="readAll" href="javascript:void(0)">@lang('Clear all')</a>
                ...
                <a href="{{route('register')}}" class="btn-custom">@lang('Join')</a>
                <a href="{{route('login')}}" class="btn-custom">@lang('Login')</a>
