                ...
                <div class="col-md-6 col-lg-3">
                    <div class="footer-box">
                        <a class="navbar-brand" href="javascript:void(0)">
                            <img class="img-fluid" src="{{ getFile(config('location.logoIcon.path') . 'logo.png') }}" alt="..." /> </a>
                        <p>
                    ...
                    <div class="footer-box">
                        ...
                        <form action="{{ route('subscribe') }}" method="post" class="mb-3">
                            ...
                            <div class="input-group mb-3">
                                <input type="email" name="email" autocomplete="off" class="form-control" placeholder="{{trans('Enter Email')}}" aria-label="Subscribe Newsletter" aria-describedby="basic-addon" />
                                <button type="submit">
