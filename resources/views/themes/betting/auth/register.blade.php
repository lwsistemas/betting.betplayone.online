                            ...
                            <div class="row g-4">
                                ...
                                <div class="input-box col-6">
                                    ...
                                    <input
                                        ...
                                        value="{{old('CPF')}}"
                                        class="form-control"
                                        placeholder="@lang('Digite seu CPF')"
                                        id="CPF"
                                        mask
                                    />
                                    @error('CPF')<span class="text-danger  mt-1">{{ $message }}</span>@enderror
                                </div>


                                <div class="input-box col-6">
                                    <label>@lang('Data de Nascimento')</label>
                                    <input
                                        type="date"
                                        name="DataNascimento"
                                        value="{{old('DataNascimento')}}"
                                        class="form-control"
                                        placeholder="@lang('Digite sua Data de Nascimento')"/>
                                    @error('DataNascimento')<span class="text-danger  mt-1">{{ $message }}</span>@enderror
                                </div>
