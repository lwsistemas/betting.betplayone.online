...
(function (t, e) {
    ...
    var e, i, a, o, n, r = "\n\nVisit documentation page to learn more: https://www.notiflix.com/documentation",
        ...
        l = {
            ...
            if (e.showOnlyTheLastOne && 0 < A) for (var R, M = t.document.querySelectorAll("[id^=" + e.ID + "-]:not([id=" + e.ID + "-" + A + "])"), B = 0; B < M.length; B++) R = M[B], null !== R.parentNode && R.parentNode.removeChild(R);
            e = y(!0, e, c)
            ...
            if ("Success" === l ? b = h(i.svgSize, f.svgColor) : "Failure" === l ? b = v(i.svgSize, f.svgColor) : "Warning" === l ? b = N(i.svgSize, f.svgColor) : "Info" == l && (b = z(i.svgSize, f.svgColor)), d.innerHTML = x + "<div class=\"" + i.className + "-content" + (i.cssAnimation ? " with-animation " : "") + " nx-" + i.cssAnimationStyle + "\" style=\"width:" + i.width + "; background:" + i.backgroundColor + "; animation-duration:" + i.cssAnimationDuration + "ms;\"><div style=\"width:" + i.svgSize + "; height:" + i.svgSize + ";\" class=\"" + i.className + "-icon\">" + b + "</div><h5 class=\"" + i.className + "-title\" style=\"font-weight:500; font-size:" + i.titleFontSize + "; color:" + f.titleColor + ";\">" + e + "</h5><p class=\"" + i.className + "-message\" style=\"font-size:" + i.messageFontSize + "; color:" + f.messageColor + ";\">" + a + "</p><a id=\"NXReportButton\" class=\"" + i.className + "-button\" style=\"font-weight:500; font-size:" + i.buttonFontSize + "; background:" + f.buttonBackground + "; color:" + f.buttonColor + ";\">" + o + "</a></div>", !t.document.getElementById(d.id)) {
                ...
                var u = t.document.getElementById(d.id), w = t.document.getElementById("NXReportButton");
            ...
            if (p && "string" == typeof f && 0 < f.length && (v = f, h = "<div><input id=\"NXConfirmValidationInput\" type=\"text\" style=\"font-size:" + a.messageFontSize + ";border-radius: " + a.borderRadius + ";\" maxlength=\"" + f.length + "\" autocomplete=\"off\" spellcheck=\"false\" autocapitalize=\"none\" /></div>"), x.innerHTML = u + "<div class=\"" + a.className + "-content\" style=\"width:" + a.width + "; background:" + a.backgroundColor + "; animation-duration:" + a.cssAnimationDuration + "ms; border-radius: " + a.borderRadius + ";\"><div class=\"" + a.className + "-head\"><h5 style=\"color:" + a.titleColor + ";font-size:" + a.titleFontSize + ";\">" + e + "</h5><div style=\"color:" + a.messageColor + ";font-size:" + a.messageFontSize + ";\">" + i + h + "</div></div><div class=\"" + a.className + "-buttons\"><a id=\"NXConfirmButtonOk\" class=\"confirm-button-ok" + ("function" == typeof r ? "" : " full") + "\" style=\"color:" + a.okButtonColor + ";background:" + a.okButtonBackground + ";font-size:" + a.buttonsFontSize + ";\">" + o + "</a>" + w + "</div></div>", !t.document.getElementById(x.id)) {
                ...
                var N = t.document.getElementById(x.id), z = t.document.getElementById("NXConfirmButtonOk"),
                ...
                if (C && (C.focus(), C.addEventListener("keyup", function (t) {
                    ...
                    if (e !== v) C.classList.add("nx-validation-failure"), C.classList.remove("nx-validation-success"); else {
            ...
            if ("string" == typeof e && 0 < e.length && (m = e), n) {
                ...
                var x = "";
                if ("standard" === a) x = C(o.svgSize, o.svgColor); else if ("hourglass" === a) x = W(o.svgSize, o.svgColor); else if ("circle" === a) x = S(o.svgSize, o.svgColor); else if ("arrows" === a) x = L(o.svgSize, o.svgColor); else if ("dots" === a) x = I(o.svgSize, o.svgColor); else if ("pulse" === a) x = R(o.svgSize, o.svgColor); else if ("custom" === a && null !== o.customSvgUrl) x = "<img class=\"custom-loading-icon\" width=\"" + o.svgSize + "\" height=\"" + o.svgSize + "\" src=\"" + o.customSvgUrl + "\" alt=\"Notiflix\">"; else {
            ...
            var v = "number" == typeof n.querySelectorLimit ? n.querySelectorLimit : 200, N = p.length >= v ? v : p.length;
            if (e) for (var z = 0; z < N; z++) {
                var M = p[z], A = M.querySelectorAll("[id^=" + f.ID + "]");
                if (1 > A.length) {
                    var X = "";
                ...
                var i = setTimeout(function () {
                    ...
                    var a = e.getAttribute("id"), o = t.document.getElementById("Style-" + a);
                    o && null !== o.parentNode && o.parentNode.removeChild(o), clearTimeout(i)
                }, n.cssAnimationDuration)
            }, J = function (t) {
                if (t && 0 < t.length) for (var e, o = 0; o < t.length; o++) e = t[o], e && (e.classList.add("remove"), $(e)); else x("Notiflix Info", "\"Notiflix.Block.Remove();\" function called with \"" + a + "\" selector, but this selector does not have a \"Notiflix.Block...\" element to remove.")
            }, Z = function (t) {
    ...
    return {Notify: H.Notify, Report: H.Report, Confirm: H.Confirm, Loading: H.Loading, Block: H.Block}
});
