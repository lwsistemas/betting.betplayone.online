...
class GameCategory extends Model
{
   ...
   /* public function activeTournament()
    {
        return $this->hasMany(GameTournament::class,'category_id')->where('showFront',1);
    }
    */

    public function activeTournament()
    {
        return $this->hasMany(GameTournament::class,'category_id')->where('showFront',1)->orderBy('name','asc');
    }
